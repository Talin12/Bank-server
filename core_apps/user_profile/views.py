            ...
            with transaction.atomic():
                ...
                if updated_instance.is_complete_with_next_of_kin():
                    ...
                    if not exsisitng_account:
                        ...
                        message = (
                            "Profile update and new bank account created successfully. An email has been sent to you with further instructions."
                        )
                    else:
                        message = (
                            "Profile update successful and no new bank account created. An email has been sent to you with further instructions."
                        )  
                    return Response(
                        {
                            "message": message,
                    ...
                    return Response(
                        {
                            "message": "Profile update successful. Please complete all required fields and at least one next of kin to create a bank account.",
                            "data": serializer.data,
                        },
                        status=status.HTTP_200_OK,
                    )
